...
expName = 'Tut 5'  # from the Builder filename that created this script
expInfo = {
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\JEMIMA\\Documents\\L in Psych Psychopy\\Tut 5_lastrun.py',
...
trials = data.TrialHandler(nReps=1.0, method='random', 
    ...
    trialList=data.importConditions('C:/Users/JEMIMA/Documents/L in Psych Psychopy/study_words.xlsx'),
...
trials_2 = data.TrialHandler(nReps=1.0, method='random', 
    extraInfo=expInfo, originPath=-1,
    trialList=data.importConditions('C:/Users/JEMIMA/Documents/L in Psych Psychopy/test_words.xlsx'),
